...
namespace Dust.Units.Data
{
	public class DataTypes : DustKey
	{
		...
		public static DataTypes Variant = new DataTypes("Data", 13);
	...
	public class DataAtts : DustKey
	{
		...
		public static DataAtts VariantValue = new DataAtts("Data", 15);
	}
	...
	public class DataLinks : DustKey
	{
		...
		public static DataLinks VariantValueType = new DataLinks("Data", 14);
	...
	public class DataValues : DustKey
	{
		private DataValues(string module, int key) : base(module, key) { }
